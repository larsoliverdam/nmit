...
This semester most of the students will be studying online from China. The communication and the time difference will surely be a challenge, not only to be understanding, but also to give me immediate feedback in MS Teams if/when something doesn’t work for you. Feedback, instant upload of material and daily communication is happening with MS Teams in our PRJ70x Team.

...
Next week I will be looking at different kinds of methods/methodologies that can be used in our research. In preparation for that I would like you to investigate the topic below that you have been allocated. You are working together to make a short presentation next week - no more than 10 min:

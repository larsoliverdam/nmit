...
This semester quite a few of the students will be studying online from China. The communication and the time difference will surely be a challenge, so I ask all of you not only to be understanding, but also please also to give me immediate feedback in MS Teams if/when something doesn’t work for you.
